This repository aims to break down the TimeWise([Live](https://timewise.herokuapp.com/user/signup), [Repo](https://github.com/Sundera96/cs-546-group-24-project)) project into a microservices architecture. 
